...
// Group 1: Spicy Amitabh/GenZ, Group 2: Spicy others, Group 3: All Mild
const LYZR_AGENTS: Record<string, { agentId: string; apiKeyGroup: 1 | 2 | 3 }> = {
  // Spicy agents
  ...
  "trump_mild": { agentId: "6940eacf3cc5fbe223af8eee", apiKeyGroup: 3 },
  "gandhi_mild": { agentId: "6941ae713cc5fbe223afe592", apiKeyGroup: 3 },
  "genz_mild": { agentId: "6941b0edf82f2b2d3f7829a9", apiKeyGroup: 3 },
  "messi_mild": { agentId: "6941b3f84f5531c6f3c6fdcd", apiKeyGroup: 3 },
  "amitabh_mild": { agentId: "6941b7da4f5531c6f3c6fde5", apiKeyGroup: 3 },
  "hawking_mild": { agentId: "6941b9594f5531c6f3c6fe07", apiKeyGroup: 3 },
};
...
serve(async (req) => {
  ...
  try {
    ...
    // Get the correct API key based on group
    const apiKey = agentConfig.apiKeyGroup === 1 
      ? Deno.env.get('LYZR_API_KEY_1')
      : agentConfig.apiKeyGroup === 2
        ? Deno.env.get('LYZR_API_KEY_2')
        : Deno.env.get('LYZR_API_KEY_MILD');
