  ...
  return (
    <div className="min-h-screen gradient-hero">
      <div className="container max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="animate-in mb-8" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {customVibes.map((vibe) => (
                <button
                  ...
                  className="px-3 py-1.5 rounded-full text-sm font-medium bg-secondary text-secondary-foreground flex items-center gap-1 group"
                >
                  {vibe}
              ...
              {!showCustomVibeInput ? (
                <button
                  ...
                  className="px-3 py-1.5 rounded-full text-sm font-medium border border-dashed border-muted-foreground/50 text-muted-foreground hover:border-primary hover:text-primary transition-colors flex items-center gap-1"
                >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="h-8 px-2 rounded bg-primary text-primary-foreground text-sm disabled:opacity-50"
                  >
                    Add
                  </button>
                  <button
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Add a one-liner about yourself..."
              maxLength={100}
