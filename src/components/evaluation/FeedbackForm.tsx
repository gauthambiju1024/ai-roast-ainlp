  ...
  return <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          {categories.map(cat => <div key={`a-${cat}`} className="space-y-1">
              ...
              <input type="range" min="0" max="1" step="0.1" value={scores.participantAScores[cat]} onChange={e => updateScore("A", cat, parseFloat(e.target.value))} className="w-full accent-primary" />
            </div>)}
        </div>
